...
import { X, Printer, Car, Calendar, Zap, Fuel, Settings2, FileText, User, Hash, MapPin, Phone, CreditCard, PenTool } from "lucide-react";
...
export const DocumentDeliveryModal = ({ isOpen, onClose, vehicle }: DocumentDeliveryModalProps) => {
    ...
    useEffect(() => {
        ...
        const fetchClients = async () => {
            ...
            // Fetch Document Delivery Recipient
        ...
        <div className="bg-card p-8 md:p-12 max-w-4xl mx-auto text-foreground font-sans relative">
            ...
            <div className="flex justify-between items-start border-b-2 border-slate-900 pb-6 mb-8">
                <div className="flex flex-col">
                    ...
                    <h1 className="text-3xl font-bold uppercase tracking-tight text-foreground">Document Delivery Note</h1>
            ...
            <div className="grid grid-cols-2 gap-12 mb-8">
                ...
                {/* --- Recipient Details (Who documents were delivered to) --- */}
                <div>
                    <h3 className="text-sm font-bold uppercase text-foreground mb-4 border-b border-border pb-2 flex items-center gap-2">
                        <User size={16} /> Documents Delivered To
                    </h3>
                    <div className="space-y-1">
                        <DetailRow label="Recipient Name" value={deliveryRecipient?.name || vehicle.docDeliveredToName || vehicle.ownerName} />
                        <DetailRow label="Phone" value={deliveryRecipient?.phone || vehicle.docDeliveredToPhone || vehicle.ownerContact} icon={Phone} />
            ...
            {vehicle.docDeliveryNote && (
                <div className="mb-8 p-4 bg-muted rounded-lg border border-blue-200">
                    <h3 className="text-sm font-bold uppercase text-foreground mb-3 flex items-center gap-2">
                        <FileText size={16} className="text-primary" /> Delivery Note
                    </h3>
            ...
            <div className="mt-16 mb-8">
                ...
                <p className="text-xs text-muted-foreground mb-8 italic">
                    By signing below, I acknowledge that I have received the vehicle documents described above in good condition and as agreed.
                </p>
                ...
                <Card className="w-full max-w-4xl max-h-[90vh] flex flex-col shadow-xl bg-card overflow-hidden">
                    <div className="flex items-center justify-between p-4 border-b border-border bg-muted">
                        <div className="flex items-center gap-2">
                            ...
                            <h3 className="font-semibold text-foreground">Print Preview - Document Delivery Note</h3>
                        </div>
