...
import {
  ...
  FileText, ChevronDown, Info, CreditCard, AlertTriangle
} from "lucide-react";
  ...
  const handleCreateInvoice = async () => {
    ...
    try {
      ...
      await runTransaction(db, async (tx) => {
        ...
        // Write one proper double-entry voucher so CashVoucherManager tracks it correctly
          ...
          {selectedVehicle && (
            <div className="pt-2 flex justify-end">
              <Button
                ...
                className="bg-secondary hover:bg-secondary/90 text-white text-white h-11 px-8 gap-2 font-semibold"
              >
                {loading
